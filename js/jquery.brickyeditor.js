                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4, BrickyEditor.Services.TemplateService.loadTemplatesAsync(editor.options.templatesUrl, editor.$editor, editor.onError)];
                        case 1:
                            templates = _a.sent();
    ...
    var Block = (function () {
        ...
        Block.prototype.bindFields = function ($block, data) {
            ...
            $fields.each(function (idx, elem) {
                ...
                var $field = $(elem);
                var field = BrickyEditor.Fields.BaseField.createField($field, data, onSelect, onUpdate, block.onUpload);
    ...
    (function (Fields) {
        var BaseField = (function () {
            ...
            BaseField.registerCommonFields = function () {
                ...
                Fields.LinkField.registerField();
                Fields.TextField.registerField();
            };
            ;
...
(function (BrickyEditor) {
    var Template = (function () {
        function Template(el) {
            ...
            this.name = data.name;
            this.class = data.class !== undefined ? data.class : null;
